    ...
    return (
        <div className="home">
            <div className="home-container">
                ...
                <div className="home-row">
                    <Product 
                            title="Dorel Living Palm Bay Full Bed, Espresso" 
                            price = {300.99}
                            image="https://images-na.ssl-images-amazon.com/images/I/81UtA2q9hfL._AC_SL1500_.jpg"
                            rating={5}
                            author="by Dorel Living Store"
                            subtitle="At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis"
